const data = [
  ...
  },
  {
    id: 115,
    title: "Mugwort",
    binomialName: "Artemisia vulgaris",
    description:
    ...
    ukOnly: true,
    image1:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Artemia_vulgaris_leaf.jpg/600px-Artemia_vulgaris_leaf.jpg",
    image2:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Artemisia_vulgaris_lower_side_of_leaf.jpg/600px-Artemisia_vulgaris_lower_side_of_leaf.jpg",
    accentColor: "#00b6b8",
  ...
  },
  {
    ...
    description:
      "Lemon balm (Melissa officinalis) is a perennial herbaceous plant in the mint family and native to south-central Europe, the Mediterranean Basin, Iran, and Central Asia, but now naturalized elsewhere. It grows to a maximum height of 100 cm (39 in). The leaves have a mild lemon scent. During summer, small white flowers full of nectar appear. It is not to be confused with bee balm (genus Monarda), although the white flowers attract bees, hence the genus Melissa (Greek for 'honey bee'). The leaves are used as a herb, in teas, and also as a flavouring. The plant is used to attract bees for honey production. It is grown as an ornamental plant and for its oil (to use in perfumery). The tea of lemon balm, the essential oil, and the extract are used in traditional and alternative medicine, including aromatherapy. Lemon balm has been cultivated at least since the 16th century. Modern research is being conducted to establish the safety and effects of the plant on humans.",
    ukOnly: true,
    image1:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Lemon_balm_plant.jpg/504px-Lemon_balm_plant.jpg",
    image2:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Bumblebee_on_Melissa_flower.jpg/450px-Bumblebee_on_Melissa_flower.jpg",
    accentColor: "#e31718",
  ...
  },
  {
    ...
    ukOnly: true,
    image1:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Br%C3%A4nn%C3%A4ssla_%28Urtica_Dioica%29.jpg/800px-Br%C3%A4nn%C3%A4ssla_%28Urtica_Dioica%29.jpg",
    image2:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Urtica_dioica38_ies.jpg/685px-Urtica_dioica38_ies.jpg",
    accentColor: "#a3ad70",
  ...
  },
  {
    id: 112,
    title: "Hawthorn",
    binomialName: "Crataegus species",
    description:
    ...
    image2:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/%28MHNT%29_Crataegus_monogyna_-_flowers_and_buds.jpg/614px-%28MHNT%29_Crataegus_monogyna_-_flowers_and_buds.jpg",
    accentColor: "#377b35",
  ...
  },
  {
    id: 125,
    title: "Marigold",
    binomialName: "Calendula officinalis",
    description:
    ...
    ukOnly: false,
    image1:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Pot_marigold.jpg/1462px-Pot_marigold.jpg",
    image2:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Calendula_officinalis%2C_pot_marigold.JPG/800px-Calendula_officinalis%2C_pot_marigold.JPG",
    accentColor: "#ef3f3a",
